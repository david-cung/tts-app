...
.PHONY: help setup-gpu setup-cpu demo docker-gpu docker-web docker-web-build docker-web-build-amd64 docker-web-save docker-web-save-amd64 check clean
...
help:
	...
	@echo "  make docker-web - run CPU Web UI with Docker"
	@echo "  make docker-web-save - export CPU Web UI image to vieneu-tts-web-cpu.tar.gz"
	@echo "  make docker-web-save-amd64 - export linux/amd64 CPU Web UI image"
...
docker-web-build:
	docker build -t vieneu-tts-web:cpu -f docker/Dockerfile.web .

docker-web-build-amd64:
	docker buildx build --platform linux/amd64 -t vieneu-tts-web:cpu-amd64 -f docker/Dockerfile.web --load .

docker-web-save: docker-web-build
	docker save vieneu-tts-web:cpu | gzip > vieneu-tts-web-cpu.tar.gz

docker-web-save-amd64: docker-web-build-amd64
